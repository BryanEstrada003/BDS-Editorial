...
CREATE VIEW nomTitSecc AS
	SELECT ri.Titulo as Titulo, r.Tipo as Tipo, r.Sección as Sección
    From RevistaInicial ri join (select *
								From RevistaFinal rf join Publicación p on rf.idRevistaFinal=p.RevistaFinal_idRevistaFinal) r
                                on ri.idRegistroRevista=r.RevistaInicial_idRegistroRevista;
